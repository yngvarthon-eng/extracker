...
int main() {
  ...
  std::cout << "Pattern commands: note set <row> <ch> <midi> <instr> [vel] [fx] [fxval], note set dry <row> <ch> <midi> <instr> [vel] [fx] [fxval], note clear <row> <ch>, note clear dry <row> <ch>, note vel <row> <ch> <vel>, note vel dry <row> <ch> <vel>, note gate <row> <ch> <ticks>, note gate dry <row> <ch> <ticks>, note fx <row> <ch> <fx> <fxval>, note fx dry <row> <ch> <fx> <fxval>, pattern print [from] [to], pattern play [from] [to], pattern template <blank|house|electro>, pattern transpose [dry [preview [verbose]]] <semitones> [from] [to] [ch], pattern velocity [dry [preview [verbose]]] <percent> [from] [to] [ch], pattern gate [dry [preview [verbose]]] <percent> [from] [to] [ch], pattern effect [dry [preview [verbose]]] <fx> <fxval> [from] [to] [ch], pattern copy <from> <to> [chFrom] [chTo], pattern paste [dry [preview [verbose]]] <destRow> [channelOffset], pattern humanize [dry [preview [verbose]]] <velRange> <gateRangePercent> <seed> [from] [to] [ch], pattern randomize [dry [preview [verbose]]] <probabilityPercent> <seed> [from] [to] [ch], pattern undo, pattern redo" << '\n';
