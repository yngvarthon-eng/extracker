...
void handleHelpCommand() {
  ...
  std::cout << "pattern transpose [dry [preview [verbose]]] s [f t c] transpose notes by semitones (optional range/channel)" << '\n';
  std::cout << "pattern velocity [dry [preview [verbose]]] p [f t c] scale velocity by percent (optional range/channel)" << '\n';
  std::cout << "pattern gate [dry [preview [verbose]]] p [f t c] scale gate ticks by percent (optional range/channel)" << '\n';
  std::cout << "pattern effect [dry [preview [verbose]]] fx fv [f t c] fill effect command/value (optional range/channel)" << '\n';
  ...
  std::cout << "pattern humanize [dry ...] vr gr seed [f t c] randomize velocity/gate around current values" << '\n';
  std::cout << "pattern randomize [dry ...] p seed [f t c] randomize velocity/effect per-step by probability" << '\n';
